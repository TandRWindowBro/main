    ...
    init: function (callback) {
        var ready = function () {
            try {
                ...
                var displayBadge = function(badgeUrl, badgeClass, badgeAlt, badgeLink, utmParameter) {
                    ...
                    if (!JotForm.enterprise) {
                        badgeWrapper.setAttribute('href', badgeLink + '/?utm_source=formfooter&utm_medium=banner&utm_term=' + formID + '&utm_content=' + utmParameter + '&utm_campaign=form_badges');
                ...
                if (JotForm.isEncrypted) {
                    displayBadge('https://cdn.jotfor.ms/assets/img/uncategorized/encrypted-form-badge.png', 'encrypted-form-badge', 'Encrypted Form', 'https://www.jotform.com/security/#Form-Encryption', 'encrypted_form');
                }
   ...
   */
    ...
    getCollapseBar: function (element) {
        ...
        if(JotForm.doubleValidationFlag()) {
            if (element.hasClassName("form-section-closed") || (element.getAttribute("id") && element.getAttribute("id").startsWith('section_'))) {
    ...
    doubleValidationFlag: function () {
        ...
        if (formID % 20 === 3) return true; // %5 of forms
    ...
    isInputAlwaysHidden: function (input) {
        ...
        var collapseBar = JotForm.getCollapseBar(input);

        if (collapseBar) {
            return collapseBar.hasClassName('form-collapse-hidden');
        }
    ...
    isSectionTouched: function (section) {
        ...
        function filterFields(el) {
            ...
            return !alwaysHidden && !isDefaultValue(el);
        }
            ...
            switch (vals[0]) {
                ...
                case "URL": // We are using URL instead of Url on some components validation, I don't want to change directly Url to URL because it can be break somewhere.
                    try {
                        ...
                        const url = new URL(checkUrlValue); 
                    } catch (error) {
